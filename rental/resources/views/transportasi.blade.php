                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="breadcrumbs-wrap">
                            <h1 class="breadcrumb-title">Armada Kami</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Layanan</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Paket Armada</li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div class="dl">
                                        <div id="main2">
                                            <a href="javascript:void(0)" class="btn btn-theme arrow-btn filter_open"
                                                onclick="openNav()" id="open2">Armada<span><i
                                        ...
                                        <div class="col-lg-12 col-md-6">
                                            <div class="ed_detail_wrap">
                                                <ul class="list_ed_detail2">
                                                    <li class="tag-2"></i><strong>Durasi:</strong>12 Jam
                                                        {{ 'Rp ' . number_format($item->harga_12, 0, ',', '.') }}
                                                        <p>MOBIL + DRIVER DILUAR OPERASIONAL (DAKOT)</p>
                                                    </li>
                                                    <li class="tag-1"></i><strong>Durasi:</strong>12 Jam All IN
                                                        {{ 'Rp ' . number_format($item->harga_12_all, 0, ',', '.') }}
                                                        <p>MOBIL + DRIVER OPERASIONAL (DAKOT)</p>
                                                    </li>
                                                    <li class="tag-3"></i><strong>Durasi:</strong>Full Day
                                                        {{ 'Rp ' . number_format($item->harga_full, 2, ',', '.') }}
                                                        <p>MOBIL + DRIVER DILUAR OPERASIONAL (DAKOT)</p>
                                                    </li>
                ...
                <div class="modal-content" id="registermodal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center">
                            <p class="mt-2">Haven't Any Account? <a href="register.html" class="link">Click
                                    here</a></p>
                        </div>
                    </div>
                </div>
