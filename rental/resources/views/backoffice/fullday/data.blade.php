                            ...
                            @foreach ($mobil as $list)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form class="delete-form" action="{{ route('full_day.destroy', $id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('full_day.edit', $id) }}" class="btn btn-warning btn-sm"
